...
// in exposrt.h EXPORT_SYMBOL(xfrm_policy_list);
...
void xfrm_dst_ifdown(struct dst_entry *dst, struct net_device *dev) //mvl void xfrm_dst_ifdown(struct dst_entry *dst)
{
//mvl	struct net_device *dev = dst->dev;
