...
#define YAFFS_MOUNT_SHRED     0x0001 /* blank old blocks */
#endif

#define YAFFS_MOUNT_NOCHKPOINT 0x0002 /* do not use the checkpoint feature */

#define clear_opt(o, opt)     o &= ~YAFFS_MOUNT_##opt
#define set_opt(o, opt)       o |= YAFFS_MOUNT_##opt
#endif
