 ...
 * Motorola 2006-Oct-02 - Add backlight support for ELBA
 * Motorola 2006-Oct-09 - Update File
 * Motorola 2006-Sep-13 - Disable low power mode for VSIM.
 * Motorola 2006-Sep-12 - Enable VESIM.
 * Motorola 2006-Aug-15 - Initial Creation
 */

#ifndef __ELBA_BASE_H__
#define __ELBA_BASE_H__
 ...
 *
 * This file contains all the register values used for the base elba.
 */
...
static const unsigned int tab_init_reg_elba_base[NUM_INIT_REGS][NUM_INIT_TABLE_COLUMNS] =
{
...
//2007-Apr-23 - Remove Power Control 1 initialization    {POWER_IC_REG_ATLAS_PWR_CONTROL_1,     0x000A005},
    ...
    {POWER_IC_REG_ATLAS_REG_SET_0,         0x0063F8C},
    {POWER_IC_REG_ATLAS_REG_SET_1,         0x0000FFC},
    {POWER_IC_REG_ATLAS_REG_MODE_0,        0x0E3A1FB},
 
    {POWER_IC_REG_ATLAS_REG_MODE_1,        0x001B019},
...
/*2006-Nov-09 - Remove LED register initialization,
    ...
    {POWER_IC_REG_ATLAS_LED_CONTROL_2,     0x000002D},
