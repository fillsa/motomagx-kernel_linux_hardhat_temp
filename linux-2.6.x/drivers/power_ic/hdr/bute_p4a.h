...
#ifndef __POWER_IC_BUTE_P4A_H__
#define __POWER_IC_BUTE_P4A_H__
 ...
 *
 * This file contains all the register values used for the p4a bute.
 */
...
static const unsigned int tab_init_reg_bute_p4a[NUM_INIT_REGS][NUM_INIT_TABLE_COLUMNS] =
{
