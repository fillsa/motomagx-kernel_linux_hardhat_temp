 ...
 * Motorola 2006-Dec-07 - Update for power cut timer
...
#ifndef __POWER_IC_ASCENSION_P3A_H__
#define __POWER_IC_ASCENSION_P3A_H__

/*!
 * @file ascension_p3a.h
 *
 * @ingroup poweric_core
 *
 * @brief The register values used in core.c
 *
 * This file contains all the register values used for the p3a ascension.
 */
...
******************************************************************************/
 ...
 static const unsigned int tab_init_reg_ascension_p3a[NUM_INIT_REGS][NUM_INIT_TABLE_COLUMNS] =
{
...
#endif /* __POWER_IC_ASCENSION_P3A_H__ */
