 ...
 * Motorola 2006-Sep-13 - Moved Lido/Saipan support to lido_base.h and saipan_base.h.
 * Motorola 2006-Jul-07 - Initial Creation
 */

#ifndef __POWER_IC_ASCENSION_P2A_H__
#define __POWER_IC_ASCENSION_P2A_H__

/*!
 * @file ascension_p2a.h
 *
 * @ingroup poweric_core
 *
 * @brief The register values used in core.c
 *
 * This file contains all the register values used for the p2a ascension.
 */
...
******************************************************************************/
 ...
 static const unsigned int tab_init_reg_ascension_p2a[NUM_INIT_REGS][NUM_INIT_TABLE_COLUMNS] =
{
...
//2007-Apr-23 - Remove Power Control 1 initialization    {POWER_IC_REG_ATLAS_PWR_CONTROL_1,     0x000A005},
    ...
    {POWER_IC_REG_ATLAS_REG_SET_0,         0x0067FBC},
