...
#if defined(CONFIG_MACH_ELBA) || defined(CONFIG_MACH_PIANOSA)
static uint32_t gCtlReg1 = 0, gCtlReg2 = 0, gCtlReg3 = 0, gCtlReg4 = 0, gCtlReg5 = 0;
#endif
...
int32_t ipu_init_channel(ipu_channel_t channel, ipu_channel_params_t * params)
{
	...
	if (gChannelInitMask & (1L << IPU_CHAN_ID(channel))) {
		DPRINTK("Warning: channel already initialized\n");
	}
...
{
              volatile unsigned long buf_num =  ipu_reserved_buff_fiq[1200],reg=0;
