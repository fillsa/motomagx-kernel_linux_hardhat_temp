...
typedef enum
{
    FW_STATE_DONE,              //complete loading firmware from proc file
    FW_STATE_LOADING,           //start loading firmware from proc file
    FW_STATE_READY,             //firmware has been successfully downloaded.
    FW_STATE_NREADY,            //firmware is not ready  
    FW_STATE_ERROR              //trigger fatal error handling          
} FW_STATE;
