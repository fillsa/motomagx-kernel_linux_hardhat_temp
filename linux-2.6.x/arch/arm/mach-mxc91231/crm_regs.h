 ...
 * 30-Nov-2006  Motorola	Clock gating changes
 * 20-Dec-2006  Motorola	More clock gating changes
...
#define MXC_ACGCR_ACG7_STOP_WAIT                          0x00400000
#define MXC_ACGCR_ACG7_STOP                               0x00C00000
#define MXC_ACGCR_ACG7_RUN                                0x01C00000
#define MXC_ACGCR_ACG7_DISABLED                           0x00000000
...
/* General clock gating definitions */ 
#define MXC_CLK_GATE_DISABLED				  0
#define MXC_CLK_GATE_STOP_WAIT				  1
#define MXC_CLK_GATE_STOP_WAIT_DELAY			  2
#define MXC_CLK_GATE_STOP				  3
#define MXC_CLK_GATE_RUN				  7

/* APGCR clock gating definitiions */
#define MXC_CLK_APGCR_DISABLED				  0
#define MXC_CLK_APGCR_STOP_WAIT      			  1
#define MXC_CLK_APGCR_STOP           			  2
#define MXC_CLK_APGCR_RUN            	 		  3

/* ACCGCR register offsets */
#define MXC_CRMAP_ACCGCR_ACCG0_OFFSET			  0x00
#define MXC_CRMAP_ACCGCR_ACCG0_MASK			  (MXC_CLK_GATE_RUN << MXC_CRMAP_ACCGCR_ACCG0_OFFSET)
#define MXC_CRMAP_ACCGCR_ACCG1_OFFSET			  0x03
#define MXC_CRMAP_ACCGCR_ACCG1_MASK			  (MXC_CLK_GATE_RUN << MXC_CRMAP_ACCGCR_ACCG1_OFFSET)
#define MXC_CRMAP_ACCGCR_ACCG2_OFFSET			  0x06
#define MXC_CRMAP_ACCGCR_ACCG2_MASK			  (MXC_CLK_GATE_RUN << MXC_CRMAP_ACCGCR_ACCG2_OFFSET)

/* APGCR register offsets */
#define MXC_CRMAP_APGCR_PGC0_OFFSET			  0x00
#define MXC_CRMAP_APGCR_PGC0_MASK			  (MXC_CLK_APGCR_RUN << MXC_CRMAP_APGCR_PGC0_OFFSET)
#define MXC_CRMAP_APGCR_PGC1_OFFSET			  0x02
#define MXC_CRMAP_APGCR_PGC1_MASK			  (MXC_CLK_APGCR_RUN << MXC_CRMAP_APGCR_PGC1_OFFSET)

/* Register values defined mainly for the clock_enable function */

/* ACCGCR */
#define ACCGCR_0_VALUE (MXC_CLK_GATE_RUN << MXC_CRMAP_ACCGCR_ACCG0_OFFSET)
#define ACCGCR_1_VALUE (MXC_CLK_GATE_RUN << MXC_CRMAP_ACCGCR_ACCG1_OFFSET)
#define ACCGCR_2_VALUE (MXC_CLK_GATE_RUN << MXC_CRMAP_ACCGCR_ACCG2_OFFSET)

/* AMLPMRA */
#define AMLPMRA_1_VALUE (MXC_CLK_GATE_STOP << MXC_CRMAP_AMLPMRA_MLPMA1_OFFSET)
#define AMLPMRA_2_VALUE (MXC_CLK_GATE_STOP << MXC_CRMAP_AMLPMRA_MLPMA2_OFFSET)
#define AMLPMRA_3_VALUE (MXC_CLK_GATE_STOP << MXC_CRMAP_AMLPMRA_MLPMA3_OFFSET)
#define AMLPMRA_4_VALUE (MXC_CLK_GATE_STOP << MXC_CRMAP_AMLPMRA_MLPMA4_OFFSET)
#define AMLPMRA_6_VALUE (MXC_CLK_GATE_STOP << MXC_CRMAP_AMLPMRA_MLPMA6_OFFSET)
#define AMLPMRA_7_VALUE (MXC_CLK_GATE_RUN << MXC_CRMAP_AMLPMRA_MLPMA7_OFFSET_PASS2)

/* AMLPMRB */
#define AMLPMRB_0_VALUE (MXC_CLK_GATE_DISABLED << MXC_CRMAP_AMLPMRB_MLPMB0_OFFSET)

/* AMLPMRC */
#define AMLPMRC_0_VALUE (MXC_CLK_GATE_RUN  << MXC_CRMAP_AMLPMRC_MLPMC0_OFFSET)
#define AMLPMRC_1_VALUE (MXC_CLK_GATE_STOP << MXC_CRMAP_AMLPMRC_MLPMC1_OFFSET)
#define AMLPMRC_2_VALUE (MXC_CLK_GATE_RUN << MXC_CRMAP_AMLPMRC_MLPMC2_OFFSET)
#define AMLPMRC_3_VALUE (MXC_CLK_GATE_STOP << MXC_CRMAP_AMLPMRC_MLPMC3_OFFSET)

#define AMLPMRC_4_VALUE (MXC_CLK_GATE_STOP << MXC_CRMAP_AMLPMRC_MLPMC4_OFFSET)
#define AMLPMRC_5_VALUE (MXC_CLK_GATE_STOP << MXC_CRMAP_AMLPMRC_MLPMC5_OFFSET)
#define AMLPMRC_7_VALUE (MXC_CLK_GATE_STOP << MXC_CRMAP_AMLPMRC_MLPMC7_OFFSET)
#define AMLPMRC_9_VALUE (MXC_CLK_GATE_DISABLED << MXC_CRMAP_AMLPMRC_MLPMC9_OFFSET)

/* AMLPMRD */
#define AMLPMRD_2_VALUE (MXC_CLK_GATE_STOP << MXC_CRMAP_AMLPMRD_MLPMD2_OFFSET)
#define AMLPMRD_3_VALUE (MXC_CLK_GATE_STOP << MXC_CRMAP_AMLPMRD_MLPMD3_OFFSET)
#define AMLPMRD_4_VALUE (MXC_CLK_GATE_RUN << MXC_CRMAP_AMLPMRD_MLPMD4_OFFSET)
#define AMLPMRD_7_VALUE (MXC_CLK_GATE_STOP << MXC_CRMAP_AMLPMRD_MLPMD7_OFFSET)

/* AMLPMRE1 */
#define AMLPMRE1_0_VALUE (MXC_CLK_GATE_RUN << MXC_CRMAP_AMLPMRE1_MLPME0_OFFSET)
#define AMLPMRE1_1_VALUE (MXC_CLK_GATE_RUN << MXC_CRMAP_AMLPMRE1_MLPME1_OFFSET)
#define AMLPMRE1_2_VALUE (MXC_CLK_GATE_STOP << MXC_CRMAP_AMLPMRE1_MLPME2_OFFSET_PASS2)
#define AMLPMRE1_3_VALUE (MXC_CLK_GATE_STOP << MXC_CRMAP_AMLPMRE1_MLPME3_OFFSET)
#define AMLPMRE1_4_VALUE (MXC_CLK_GATE_STOP << MXC_CRMAP_AMLPMRE1_MLPME4_OFFSET)
#define AMLPMRE1_5_VALUE (MXC_CLK_GATE_STOP << MXC_CRMAP_AMLPMRE1_MLPME5_OFFSET)
#define AMLPMRE1_6_VALUE (MXC_CLK_GATE_STOP << MXC_CRMAP_AMLPMRE1_MLPME6_OFFSET)
#define AMLPMRE1_7_VALUE (MXC_CLK_GATE_STOP << MXC_CRMAP_AMLPMRE1_MLPME7_OFFSET)

/* AMLPMRE2 */
#define AMLPMRE2_0_VALUE (MXC_CLK_GATE_DISABLED << MXC_CRMAP_AMLPMRE2_MLPME0_OFFSET)

/* AMLPMRF */
#define AMLPMRF_0_VALUE (MXC_CLK_GATE_RUN << MXC_CRMAP_AMLPMRF_MLPMF0_OFFSET_PASS2)
#define AMLPMRF_1_VALUE (MXC_CLK_GATE_STOP << MXC_CRMAP_AMLPMRF_MLPMF1_OFFSET)
#define AMLPMRF_2_VALUE (MXC_CLK_GATE_RUN << MXC_CRMAP_AMLPMRF_MLPMF2_OFFSET)
#define AMLPMRF_3_VALUE (MXC_CLK_GATE_STOP << MXC_CRMAP_AMLPMRF_MLPMF3_OFFSET)
#define AMLPMRF_5_VALUE (MXC_CLK_GATE_RUN << MXC_CRMAP_AMLPMRF_MLPMF5_OFFSET)
#define AMLPMRF_6_VALUE (MXC_CLK_GATE_DISABLED << MXC_CRMAP_AMLPMRF_MLPMF6_OFFSET)

/* AMLPMRG */
#define AMLPMRG_0_VALUE (MXC_CLK_GATE_DISABLED << MXC_CRMAP_AMLPMRG_MLPMG0_OFFSET)
#define AMLPMRG_1_VALUE (MXC_CLK_GATE_STOP << MXC_CRMAP_AMLPMRG_MLPMG1_OFFSET)
#define AMLPMRG_2_VALUE (MXC_CLK_GATE_RUN << MXC_CRMAP_AMLPMRG_MLPMG2_OFFSET)
#define AMLPMRG_3_VALUE (MXC_CLK_GATE_STOP << MXC_CRMAP_AMLPMRG_MLPMG3_OFFSET)
#define AMLPMRG_4_VALUE (MXC_CLK_GATE_RUN << MXC_CRMAP_AMLPMRG_MLPMG4_OFFSET)
#define AMLPMRG_5_VALUE (MXC_CLK_GATE_STOP << MXC_CRMAP_AMLPMRG_MLPMG5_OFFSET)
#define AMLPMRG_6_VALUE (MXC_CLK_GATE_RUN << MXC_CRMAP_AMLPMRG_MLPMG6_OFFSET)
#define AMLPMRG_7_VALUE (MXC_CLK_GATE_STOP << MXC_CRMAP_AMLPMRG_MLPMG7_OFFSET)
#define AMLPMRG_9_VALUE (MXC_CLK_GATE_STOP << MXC_CRMAP_AMLPMRG_MLPMG9_OFFSET)

/* APGCR */
#define APGCR_0_VALUE (MXC_CLK_APGCR_STOP_WAIT << MXC_CRMAP_APGCR_PGC0_OFFSET)
#define APGCR_1_VALUE (MXC_CLK_APGCR_STOP_WAIT << MXC_CRMAP_APGCR_PGC1_OFFSET)
