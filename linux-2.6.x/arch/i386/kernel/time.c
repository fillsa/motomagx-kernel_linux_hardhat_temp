...
DEFINE_RAW_SPINLOCK(rtc_lock); //2.6.12	+DEFINE_SPINLOCK(rtc_lock);
EXPORT_SYMBOL(rtc_lock);

#include <asm/i8253.h>

DEFINE_RAW_SPINLOCK(i8253_lock); //2.6.12	+DEFINE_SPINLOCK(i8253_lock);
...
//2.6	do_timer_interrupt_hook(regs);
