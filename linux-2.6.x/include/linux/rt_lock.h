 ...
 *
 * Date        Author    Comment
 * 09/13/2005  Motorola  Added to new kernel interface called
...
extern int FASTCALL(down_interruptible_timeout(struct compat_semaphore * sem, signed long timeout));
#endif
