 ...
 */
#define __xipram __noinstrument __attribute__ ((__section__ (".data")))
...
#define xip_elapsed_since(x)	(signed)((~xip_omap_mpu_timer_read(0) - (x)) / 6)
	...
	defined(CONFIG_MACH_MXC27530ADS) || \
	defined(CONFIG_MACH_I30030EVB) || \
	defined(CONFIG_MACH_MXC30030EVB) || \
	defined(CONFIG_MACH_MXC27530EVB) || \
